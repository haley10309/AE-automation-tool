...
const SEED_SERVICE_DATA = {
  ...
  CZ:        { samsungHealth: { text: 'Samsung Health', url: '/cz/apps/samsung-health/' }, appsServices: { text: 'Aplikace a služby', url: '/cz/apps/' }, carePlus: null, tradeIn: { text: 'Samsung Trade-in', url: '/cz/trade-in/' } },
